...
const WarehouseTable = () => {
  ...
  return (
    <div className="flex-1 outline-none relative flex flex-col gap-4 overflow-auto">
      ...
      <div className="flex items-center text-sm">
        <p className="shrink-0 hidden lg:block">1 - 10 / 100 Kết quả</p>
        ...
        <div className="flex gap-8 items-center ml-auto">
          ...
          <p className="lg:hidden">Trang 1 trong 10</p>
          ...
          <Pagination className="w-auto mx-0 hidden lg:flex">
            <PaginationContent>
              <PaginationItem>
                <Button disabled variant={"outline"} size={"icon"}>
                  <ChevronLeftIcon className="w-4 h-4" />
